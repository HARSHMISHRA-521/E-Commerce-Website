 ...
 *
 * @param {Object} req - The request object containing the product ID and quantity to remove.
 * @param {Object} res - The response object to send the result back to the client.
 * @param {Function} next - The next middleware function in the chain.
 * @return {Promise<void>} A promise that resolves when the product is removed from the cart.
 */
 ...
 *
 * @param {Object} req - The request object containing the user's JWT.
 * @param {Object} res - The response object to send the cart items back to the client.
 * @param {Function} next - The next middleware function in the chain.
 * @return {Promise<void>} A promise that resolves when the cart items are sent back to the client.
 */
 ...
 * @param {Object} res - The response object to send the order status back to the client.
 * @param {Function} next - The next middleware function in the chain.
 * @return {Promise<void>} A promise that resolves when the order is placed successfully.
 */
 ...
 * @param {Object} res - The response object to send the orders back to the client.
 * @param {Function} next - The next middleware function in the chain.
 * @return {Promise<Object>} A promise that resolves with the orders in JSON format.
 */
 ...
 * @param {Object} res - The response object to send the result back to the client.
 * @param {Function} next - The next middleware function in the chain.
 * @return {Promise<Object>} A promise that resolves with a JSON object containing the updated user and a success message.
 */
...
/**
 * Retrieves the user's favourite products from the database.
 *
 * @param {Object} req - The request object containing the user's ID.
 * @param {Object} res - The response object to send the favourite products back to the client.
 * @param {Function} next - The next middleware function in the chain.
 * @return {Promise<Object>} A promise that resolves with a JSON object containing the user's favourite products.
 */
