...
/**
 * A functional component that renders the shop listing page.
 * It fetches products based on the selected filters and displays them in a grid.
 * The filters include price range, sizes, and categories.
 *
 * @return {JSX.Element} The JSX element representing the shop listing page.
 */
const ShopListing = () => {
  ...
  /**
   * Fetches products from the API based on the selected filters and updates the state.
   *
