...
/**
 * Renders the details of a product, including its image, title, price, description,
 * available sizes, and options to add to cart, buy now, and add to favorites.
 *
...
const ProductDetails = () => {
  ...
  /**
   * Retrieves product details from the server and updates the component state.
   *
   * @return {Promise<void>} A promise that resolves when the product details have been fetched and the state has been updated.
   */
  ...
  /**
   * Adds the current product to the user's cart by making an asynchronous request to the server.
   * If successful, sets the 'cartLoading' state to false and navigates to the cart page.
   * If an error occurs, sets the 'cartLoading' state to false and displays an error message using the 'openSnackbar' action.
   *
   * @return {Promise<void>} A promise that resolves when the request is complete.
   */
  const addCart = async () => {
